...
import Collect from './follow/collect'
import Collecting from './follow/collecting'

export default function BlogFavIcon2({ blogarticle_id }) {
  ...
  return (
    <>
      {auth.id > 0 && (
        ...
        >
          {isFavorited ? <Collecting   size={30}
                          color="red"/> : <Collect  size={30}
                          color="red"/>}
        </div>
      )}
    </>
